...
export default class Buildings extends React.Component {
    ...
    onScroll(scrollY) {
        ...
        if(screenWidth > 650) left1.style.transform = `translateY(${Math.floor(-scrollY/14 + 400)}px)`
        else left1.style.transform = `translateY(${Math.floor(-scrollY/26 + 550)}px)`

        const left2 = document.getElementById('left-border-building-2')
        if(screenWidth > 650) left2.style.transform = `translateY(${Math.floor(-scrollY/20 + 570)}px)`
        else left2.style.transform = `translateY(${Math.floor(-scrollY/36 + 600)}px)`

        const right1 = document.getElementById('right-border-building-1')
        if(screenWidth > 650) right1.style.transform = `translateY(${Math.floor(-scrollY/14 + 650)}px)`
        else right1.style.transform = `translateY(${Math.floor(-scrollY/34 + 650)}px)`

        const right2 = document.getElementById('right-border-building-2')
        if(screenWidth > 650) right2.style.transform = `translateY(${Math.floor(-scrollY/8 + 650)}px)`
        else right2.style.transform = `translateY(${Math.floor(-scrollY/28 + 650)}px)`

        const right3 = document.getElementById('right-border-building-3')
        if(screenWidth > 650) right3.style.transform = `translateY(${Math.floor(-scrollY/18 + 500)}px)`
        else right3.style.transform = `translateY(${Math.floor(-scrollY/38 + 500)}px)`

        // outer buildings
        const left3 = document.getElementById('left-border-building-3')
        left3.style.transform = `translateY(${Math.floor(-scrollY/18 + 250)}px)`
        const left4 = document.getElementById('left-border-building-4')
        left4.style.transform = `translateY(${Math.floor(-scrollY/15 + 400)}px)`
        const left5 = document.getElementById('left-border-building-5')
        left5.style.transform = `translateY(${Math.floor(-scrollY/28 + 450)}px)`

        const right4 = document.getElementById('right-border-building-4')
        right4.style.transform = `translateY(${Math.floor(-scrollY/10 + 400)}px)`
        const right5 = document.getElementById('right-border-building-5')
        right5.style.transform = `translateY(${Math.floor(-scrollY/10 + 700)}px)`
    }
