...
export default class Buildings extends React.Component {
    ...
    onScroll(scrollY) {
        ...
        if(screenWidth > 650) right1.style.marginTop = `${Math.floor(-scrollY/14 + 650)}px`
        else right1.style.marginTop = `${Math.floor(-scrollY/34 + 650)}px`

        const right2 = document.getElementById('right-border-building-2')
        if(screenWidth > 650) right2.style.marginTop = `${Math.floor(-scrollY/8 + 650)}px`
        else right2.style.marginTop = `${Math.floor(-scrollY/28 + 650)}px`

        const right3 = document.getElementById('right-border-building-3')
        if(screenWidth > 650) right3.style.marginTop = `${Math.floor(-scrollY/18 + 500)}px`
        else right3.style.marginTop = `${Math.floor(-scrollY/38 + 500)}px`
