...
export default class Stars extends React.Component {
    ...
    startAnimation(starNum) {
        ...
        var star = document.getElementById(`star-${starNum}-tech`)
    ...
    render() {
        return (
            <div id='stars'>
                <div className='sprite star' id='star-1-tech'></div>
                <div className='sprite star' id='star-2-tech'></div>
                <div className='sprite star' id='star-3-tech'></div>
